...
{
    [gitlab-runner-awsaResourceType("gitlab-runner-awsa:index:StaticPage")]
    public partial class StaticPage : Pulumi.ComponentResource
    {
        ...
        public StaticPage(string name, StaticPageArgs args, ComponentResourceOptions? options = null)
            : base("gitlab-runner-awsa:index:StaticPage", name, args ?? new StaticPageArgs(), MakeResourceOptions(options, ""), remote: true)
        {
        }
