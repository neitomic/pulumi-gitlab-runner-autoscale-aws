...
namespace Pulumi.gitlab-runner-awsa
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.gitlab-runner-awsa.version.txt");
    ...
    internal sealed class gitlab-runner-awsaResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public gitlab-runner-awsaResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
